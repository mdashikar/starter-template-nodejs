...
- **Fork the repo**
- **Clone the repo** and set it up (check out the [manual installation](https://github.com/mdashikar/starter-template-nodejs#manual-installation) section in README.md)
