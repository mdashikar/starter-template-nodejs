...
if (process.argv.length < 3) {
  ...
  console.log('    npx create-starter-template-nodejs my-app');
  console.log('    OR');
  console.log('    npm init starter-template-nodejs my-app');
  process.exit(1);
}
...
const repo = 'https://github.com/mdashikar/starter-template-nodejs';
